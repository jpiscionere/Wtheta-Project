...
static PyObject *chi2_fof_chi2_fof(PyObject *self, PyObject *args)
{
  ...
  int lum_sample,bender;

  /* Parse the input tuple */
  if (!PyArg_ParseTuple(args, "iiddddddd",&lum_sample,&bender,&box_choose,&siglogM,&logM0,&logM1,&alpha,&gamma,&fgal))
    return NULL;

  /* Call the external C function to compute the chi-squared. */
  double value = chi2_fof(lum_sample,bender,box_choose,siglogM,logM0,logM1,alpha,gamma,fgal);
