...
status_file="status_file_consuelo21.out"
pickle_file="status_file_consuelo21.pkl"
ndim=5
nwalkers=500
nburn_in=5
box=np.array([np.random.randint(0,9) for col in range(nwalkers)])
box=box.reshape(nwalkers,1)
start_positions=np.array([ 13.06050679001 ,  1.15246263627 ,  1.62330725248 ,  0.220777562472])
