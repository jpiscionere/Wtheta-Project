...
/*   @-@
     |
     @-@ 
Normally, you would loose 2, but now you can get everything. 
...
Normally you would loose 2, but now you get all.
*/
...
Normally we would get 2, now we get all
...
Normally we would get 2, now we can get all
 */
...
randomly choose 1 to throw out.
