...
/*---Halo-centers----------------------*/
  ...
  float *Rvir,*Mhalo,*xcen,*ycen,*zcen,*vxcen,*vycen,*vzcen ;
...

{
  ...
  pnmfile = argv[16];
  sscanf(argv[17],"%lu",&seed) ; // This seed is for choosing number of galaxies
...
/*---Read-group-info-in-BGC-files-----------------------------------------------------*/
  ...
  i=0; 
  while(fscanf(stdin,"%d %d %lf %f %f %f %f %f %f %lf %d",&junki,&Npart,&junklf,&xcen[i],&ycen[i],&zcen[i],&vxcen[i],&vycen[i],&vzcen[i],&junklf,&junki)!=EOF) 
  {
