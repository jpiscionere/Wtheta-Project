...
/*---Read-particle-file-----------------------------------------------------*/
  ...
  vx=(double *) calloc(np,sizeof(double));       
  vy=(double *) calloc(np,sizeof(double));       
  vz=(double *) calloc(np,sizeof(double));       
  
      
  ftread(x,sizeof(double),np,stdin);

  ftread(y,sizeof(double),np,stdin);

ftread(z,sizeof(double),np,stdin);
  ftread(vx,sizeof(double),np,stdin);

  ftread(vy,sizeof(double),np,stdin);
  ftread(vz,sizeof(double),np,stdin);
