...
static PyObject *chi2_fof_chi2_fof(PyObject *self, PyObject *args)
{
  ...
  double box_choose,logM1,alpha,gamma,fgal;
  int lum_sample;

  /* Parse the input tuple */
  if (!PyArg_ParseTuple(args, "iddddd",&lum_sample,&box_choose,&logM1,&alpha,&gamma,&fgal))
    return NULL;

  /* Call the external C function to compute the chi-squared. */
  double value = chi2_fof(lum_sample,box_choose,logM1,alpha,gamma,fgal);
